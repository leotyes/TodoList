...
class EditLocationRemindCalendarManager(private val context: Context, private val container: LinearLayout, private val layoutInflater: LayoutInflater, private val viewModel: CalendarFragmentViewModel) {
    private val items = mutableListOf<EditLocationRemindCalendarItem>()
    ...
    fun addItem() {
        ...
        val item = EditLocationRemindCalendarItem(binding, this, context, nextId)
    ...
    fun removeItem(item: EditLocationRemindCalendarItem) {
...
class EditLocationRemindCalendarItem(val binding: LocationRemindItemBinding, private val manager: EditLocationRemindCalendarManager, private val context: Context, val nextId: Int) {
